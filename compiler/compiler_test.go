...
func runCompilerTests(t *testing.T, tests []compilerTestCase) {
	// t.Helper() removes this func from error stack traces, and the
	// book states it abstracts away shared test behavior.
	t.Helper()
...
func TestCompilerScopes(t *testing.T) {
	// Instructions emitted in one scope do not effect another scope.
	compiler := New()
	...
	tests := []compilerTestCase{
		{
			...
			expectedConstants: []interface{}{
				24,
				[]code.Instructions{
					code.Make(code.OpConstant, 0), // int literal 24
					code.Make(code.OpReturnValue),
				},
			},
			expectedInstructions: []code.Instructions{
		...
		},
		{
			...
			expectedConstants: []interface{}{
				24,
				[]code.Instructions{
					code.Make(code.OpConstant, 0), // int 24
					code.Make(code.OpReturnValue),
				},
			},
			expectedInstructions: []code.Instructions{
				code.Make(code.OpConstant, 1), // compiled functions
				code.Make(code.OpSetGlobal, 0),
				code.Make(code.OpGetGlobal, 0),
				code.Make(code.OpCall, 0),
				code.Make(code.OpPop),
